  ...
  return (
    <div style={styles.suspectFormContainer}>
      ...
      <form encType="multipart/form-data">
        ...
        <label htmlFor="identityProof" style={styles.label}>Identity Proof:</label>
        <select
          id="identityProof"
          value={identityProof}
        ...
        <label htmlFor="file" style={styles.label}>Upload File (optional):</label>
        <input
          type="file"
          id="file"
...
const styles = {
  ...
  '@media (max-width: 768px)': {
    ...
    buttonContainer: {
      flexDirection: 'column',  // Stack the buttons vertically on smaller screens
      alignItems: 'center',
    },
    addButton: {
      marginLeft: '0',
      marginTop: '10px',  // Space between buttons on mobile
    },
    cancelButton: {
      marginBottom: '10px', // Space between buttons on mobile
    },
  },

  '@media (max-width: 480px)': {
    suspectFormContainer: {
      width: '95%',  // Make it 95% for even smaller screens
    },
    formImage: {
      width: '100%',
      height: 'auto',
